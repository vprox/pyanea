@extends('layout')
@section('content')
            <?php $prothesmia='30 Ιουνίου 2017 ώρα: 15:00' ?>
            <div class="content">
              <!--   <div class="title ">
                ...
                <div class="jumbotron w3-panel w3-orange">
                    ...
                    <ul>
                        ...
                        <li><b>Να τροποποιήσετε τις προτιμήσεις σας όσες φορές θέλετε μέχρι: <span style='color:blue'><em>{{$prothesmia}}</em></span></b></li>
                ...
                <div class="w3-panel w3-blue w3-round"> 
                 <p>Αναζητήστε τις προτιμήσεις σας χρησιμοποιώντας τον ΑΦΜ σας και τον ΑΤ (ή Αριθμό Διαβατηρίου) που είχατε δηλώσει στην αίτηση σας. </p>     
                   <div class='btn-group'>
                    ...
                    <br>μέχρι: <b style='color:blue'>{{$prothesmia}}</b>
                            </div>

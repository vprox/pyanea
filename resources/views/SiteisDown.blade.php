                ...
                <div class="w3-panel w3-blue w3-round"> 
                 <p>Αναζητήστε τις προτιμήσεις σας χρησιμοποιώντας τον ΑΦΜ σας και τον ΑΤ (ή Αριθμό Διαβατηρίου) που είχατε δηλώσει στην αίτηση σας. </p>     
                   <div class='btn-group'>
                        ...
                        <button type='button' class='btn btn-danger btn-md' disabled><i class='w3-large fa fa-search '> </i>Φόρμα Αναζήτησης</button>
                        </a>
                        <p>Η Περίοδος δηλώσεων έληξε την {{$prothesmia}}</p>
                    </div>
                </div>  
